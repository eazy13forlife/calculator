...
var subtract = function subtract(numbers) {
...
var divide = function divide(array) {
...
document.querySelector("#equals").addEventListener("click", function (e) {
  ...
  if (numbersArray.length === 1 || numbersArray.length === 0) {} else {
    ...
    if (letterNumber === "") {} else {
      ...
      newNumbersArray.forEach(function (number, index) {
...
document.querySelector("#delete").addEventListener("click", function (e) {
  ...
  if (letterNumber === "" || typeof displayValue === "number") {} else {
